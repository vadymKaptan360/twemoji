...
```html
<script src="hhttps://cdn.jsdelivr.net/npm/twemoji@14.0.2/dist/twemoji.min.js integrity="sha384-fnFPYlhNf3STPDIrLJAcAdi9ehsmkE48MwSD7LehvZ9jqMgEm7nuVLXvXXMIQDn0" crossorigin="anonymous"></script>
```
